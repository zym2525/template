...
import { ActivityIndicator, Surface, TouchableRipple, withTheme, Colors } from 'react-native-paper'
...
const Button = ({
    ...
    if (mode === 'outlined') {
        borderColor = color(theme.dark ? Colors.white : Colors.black)
            .alpha(0.29)
            .rgb()
            .string();
    ...
    if (disabled) {
        textColor = color(theme.dark ? Colors.white : Colors.black)
            .alpha(0.32)
            .rgb()
            .string();
